function initializeGame() {
 ...
 // 初始化当前关卡
 loadLevel(currentLevel); // 从levelManager获取当前关卡号
...
platforms.push(new Platform(300, 500, blockSize, blockSize * 3));     // 左竖墙
  ...
  // 添加多个故事碎片（x, y, w, h, 内容）
  storyFragments.push(new StoryFragment(150, 100, 50, 50, "Fragments of a story 1"));
  storyFragments.push(new StoryFragment(100, 340, 60, 60, "Fragments of a story 2"));
  storyFragments.push(new StoryFragment(450, 230, 70, 70, "Fragments of a story 3"));*/
}